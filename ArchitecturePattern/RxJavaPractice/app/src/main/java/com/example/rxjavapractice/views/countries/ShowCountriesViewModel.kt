...
class ShowCountriesViewModel : ViewModel() {
    ...
    var countriesService = RetrofitInstance.getInstance()

    // os에 의해 앱의 프로세스가 죽거는 등의 상황에서 Single 객체를 가로채기 위함
    ...
    private fun fetchCountries() {
        ...
        val countryInfo: Single<List<CountryModel>>? = countriesService?.getCountries()

        val country = countryInfo // Single<List<CountryModel>>를 반환한다.
